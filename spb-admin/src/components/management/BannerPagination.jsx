...
class BannerPagination extends PureComponent {
  constructor(props) {
    super(props);
  ...
  handleNextPress() {
    const { requestBannerList, pageNumber, searchParams } = this.props;
    requestBannerList(searchParams, pageNumber + 1);
  }
  handlePrevPress() {
    const { requestBannerList, pageNumber, searchParams } = this.props;
    requestBannerList(searchParams, pageNumber - 1);
