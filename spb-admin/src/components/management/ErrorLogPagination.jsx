...
class ErrorLogPagination extends PureComponent {
  constructor(props) {
    super(props);
  ...
  handleNextPress() {
    const { requestErrorLogList, pageNumber, searchParams } = this.props;
    requestErrorLogList(searchParams, pageNumber + 1);
  }
  handlePrevPress() {
    const { requestErrorLogList, pageNumber, searchParams } = this.props;
    requestErrorLogList(searchParams, pageNumber - 1);
...
ErrorLogPagination.propTypes = {
  hasNext: PropTypes.bool,
  pageNumber: PropTypes.number,
  // loading: PropTypes.bool,
  requestErrorLogList: PropTypes.func.isRequired,
};

export default ErrorLogPagination;
